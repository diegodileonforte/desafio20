...
class Producto {
    ...
    async findByID(req, res) {
        ...
        try {
            ...
            const prodById = await ProductoDAO.findOne({ _id })
    ...
    async deleteProd(req, res) {
        ...
        try {
            ...
            const prodToDel = await ProductoDAO.deleteOne({ _id });
    ...
    async update(req, res) {
        ...
        const data = { ...req.body }
        try {
            const prodUpdated = await ProductoDAO.updateOne({ _id }, data, { new: true })
